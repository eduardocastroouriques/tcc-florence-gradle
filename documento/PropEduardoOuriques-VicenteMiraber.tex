...
O diagrama de classe demonstrado na Figura \ref{fig:erDiagram} representa a implementação abstrata que foi desenvolvida para o software Florence.
...
Para acessar o software Florence o usuário do tipo Hospital, CIHDOTT ou OPO, deve realizar o login informando usuário e senha conforme demonstrado na Figura \ref{fig:login}.
...
Após o login, o usuário é redirecionado para a tela representada pela Figura \ref{fig:prontuarios}, que lista todos os prontuários ativos e disponíveis para visualização e edição.
...
Para a inserção de um novo prontuário basta clicar no símbolo de adição no canto superior direito da tela conforme demonstrado na Figura \ref{fig:prontuarios}. 

O usuário é redirecionado para tela representada pela Figura \ref{fig:prontuarios}, nela o usuário preenche os dados gerais do prontuário, aonde constam informações como, nome, RG, CPF, e demais informações de preenchimento obrigatório. 
...
\includegraphics[width=11cm]{50-1-response-time}
...
\includegraphics[width=11cm]{50-1-memory}
...
\includegraphics[width=11cm]{50-10-response-time}
...
\includegraphics[width=11cm]{50-10-memory}
...
\includegraphics[width=11cm]{100-10-response-time}
...
\includegraphics[width=11cm]{100-10-memory}
