...
\chapter{Avaliação}
Este capítulo descreve a avaliação realizada no software de captação e doação de órgãos ou tecidos que esclarece alguns pontos técnicos relacionados a performance da aplicação. 

\section{Novo processo - 50 usuários - 100 requisições}
Esta seção descreve o tempo de resposta, taxa de transferência e uso de memória consumido ao requisitar com 50 usuários e 100 requisições por usuário o serviço de criação de um novo processo de doação.

\paragraph*{• Tempo de Resposta}

\paragraph*{• Taxa de Transferência}

\paragraph*{• Uso de memória}

\section{Novo processo - 500 usuários - 100 requisições}
Esta seção descreve o tempo de resposta, taxa de transferência e uso de memória consumido ao requisitar com 500 usuários e 100 requisições por usuário o serviço de criação de um novo processo de doação

Para avaliar o sistema o grupo utilizou dados fictícios, instalou e configurou o software em uma nuvem pública da empresa Heroku que provê um servidor rodando Linux com 512MB de memória RAM e 2 núcleos de processamento.  
...
\section{Novo processo - 1000 usuários - 100 requisições}
Esta seção descreve o tempo de resposta, taxa de transferência e uso de memória consumido ao requisitar com 1000 usuários e 100 requisições por usuário o serviço de criação de um novo processo de doação.
